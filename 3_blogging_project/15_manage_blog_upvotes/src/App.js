/**update:
 * Upvote Logic:
 * - Users can upvote articles once.
 * - Upvoting increases an article's count.
 * - Alerts users when they try to upvote the same article again.
 *
 * Components:
 * - `ArticlePage.jsx`: Manages article display and upvoting logic.
 *
 * Redux:
 * - `auth.js`: Handles upvoting actions.
 * - `reducer.js`: Tracks upvoted articles.
 */
// App.js
